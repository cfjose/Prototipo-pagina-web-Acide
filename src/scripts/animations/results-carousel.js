...
/*
  ...
  3=costado derecho, 4=fuera por la derecha). Tamaños: centro 1184x664,
  costados 683x384, gap 24px fijo (se escala parejo si no entra en
  pantalla, ver computeScale).
